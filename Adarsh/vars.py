...
class Var(object):
    ...
    BOT_TOKEN = str(getenv('BOT_TOKEN',"5547113554:AAETQSL73_XfkcXN351sq1kT29qMe3_3Vw8"))
  ...
  #  else:
    ON_HEROKU = False 
    FQDN = str(getenv('FQDN','BIND_ADDRES')) if not ON_HEROKU or getenv(FQDN) else APP_NAME + "koyeb.app"
